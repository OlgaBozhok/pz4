...
public class AppTest3 {
    ...
    public void simpleApplication() throws SQLException {
        ...
        //Ввести запрос для добавления нового товара: "INSERT INTO FOOD VALUES (5,' ',' ', 1);"

        String insert = "INSERT INTO FOOD(FOOD_ID, FOOD_NAME, FOOD_TYPE, FOOD_EXOTIC) values (5, ' ', ' ', 1)";
